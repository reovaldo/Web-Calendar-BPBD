...
<head>
    <meta charset="utf-8" />
    <title>Kalender BPBD Jawa Tengah</title>
...
<body>
    ...
    <nav class="navbar navbar-default">
      <div class="container-fluid">
          ...
          <left>
            <img id="logo" src="assets/images/logo-web.png" width="475" height="60">
        </left>
    </div>
</nav>        
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <b>Deskripsi</b>
                                            <p id="description"></p>
                                            <img id="image" src="" alt="" class="img-thumbnail">
                                            <br>
                                            <b>Tanggal Mulai</b>
                                            <p id="start"></p>
...
<script type="text/javascript">
    ...
    {
        // console.log(event)
        // $('input[name=calendar_id]').val(event.id);
        $('#title').html(event.title);
        $('#description').html(event.description);
        $('#image').attr('src', event.image);
        $('#start').html(moment(event.start).format('YYYY-MM-DD'));
        $('#end').html(moment(event.end).format('YYYY-MM-DD'));
